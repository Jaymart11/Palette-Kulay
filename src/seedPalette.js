export default [
  ...
  {
    paletteName: "Flat UI Colors England",
    id: "flat-ui-colors-england",
    emoji: "🤴",
    colors: [
      { name: "AmericanRiver", color: "#636e72" },
      { name: "BrightYarrow", color: "#fdcb6e" },
  ...
  {
    paletteName: "Flat UI Colors China",
    id: "flat-ui-colors-china",
    emoji: "🤏",
    colors: [
      { name: "green", color: "#4CAF50" },
      { name: "lightgreen", color: "#8BC34A" },
  ...
  {
    paletteName: "Flat UI Colors danish",
    id: "flat-ui-colors-danish",
    emoji: "🥓",
    colors: [
      { name: "ChileanFire", color: "#cd6133" },
      { name: "GreyPorcelain", color: "#84817a" },
